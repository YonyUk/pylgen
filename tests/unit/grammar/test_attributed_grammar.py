...
class TestGrammar:
    ...
    @pytest.fixture
    def G1(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        E -> T X
        ...
        g[E] += (T,X),comodin_reductor

        g[X] += (plus,T,X),comodin_reductor
        g[X] += (eps,),comodin_reductor

        g[T] += (lparen,E,rparen),comodin_reductor
        g[T] += (n,),comodin_reductor

        return g,(E,T,X,plus,n,lparen,rparen,eps)
    
    # LR clasic grammar
    @pytest.fixture
    def G2(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        E -> E + T | T
    ...
    @pytest.fixture
    def G3(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        S -> A B C
        ...
        g[S] += (A,B,C),comodin_reductor
        
        g[A] += (a,),comodin_reductor
        g[A] += (eps,),comodin_reductor

        g[B] += (b,),comodin_reductor
        g[B] += (eps,),comodin_reductor

        g[C] += (c,),comodin_reductor
        g[C] += (eps,),comodin_reductor

        return g,(S,A,B,C,a,b,c,eps)

    # grammar with n-direct ε-derivation
    @pytest.fixture
    def G4(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        S -> A
    ...
    @pytest.fixture
    def G5(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        S -> A a A
    ...
    # ciclic grammar
    @pytest.fixture
    def G6(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        A -> B
    ...
    @pytest.fixture
    def G7(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        S -> a
        '''
        S = Symbol('S')
    ...
    @pytest.fixture
    def G8(self) -> Tuple[AttributedGrammar,Tuple[Symbol,...]]:
        '''
        S -> A a | a
        ...
        g[S] += (A,a),comodin_reductor
        g[S] += (B,b),comodin_reductor
        g[S] += (a,),comodin_reductor
        g[S] += (b,),comodin_reductor

        g[A] += (A,a),comodin_reductor
        g[A] += (B,),comodin_reductor
        g[A] += (eps,),comodin_reductor

        g[B] += (B,b),comodin_reductor
        g[B] += (A,),comodin_reductor
        g[B] += (eps,),comodin_reductor
    ...
    def G9(self) -> AttributedGrammar:
        ...
        G[S] += (_0,S),comodin_reductor
        G[S] += (_1,A),comodin_reductor

        G[A] += (_0,S),comodin_reductor
        G[A] += (_1,A),comodin_reductor
        G[A] += (eps,),comodin_reductor
    ...
    def test_add_one_production(self):
        ...
        assert G.get_reductor(Production(E,[E,plus,T])) == comodin_reductor
    ...
    def test_add_many_productions_same_head(self):
        ...
        for p in prods:
            assert p.head == E
            assert G.get_reductor(p) == comodin_reductor
    ...
    def test_add_epsilon_production(self):
        ...
        G = AttributedGrammar(E)
        G[E] += (eps,),comodin_reductor

        assert len(G.productions) == 1
        prod = next(iter(G.productions))
        assert G.get_reductor(prod) == comodin_reductor
        assert prod.head == E
    ...
    def test_grammar_unique_epsilon_symbol(self):
        ...
        G = AttributedGrammar(E)
        G[E] += (T,eps1),comodin_reductor

        with pytest.raises(ValueError,match='Only can exists one epsilon symbol'):
            G[E] += (T,eps2),comodin_reductor
    
    def test_grammar_first(self,G1:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
    ...
    def test_grammar_follow(self,G1:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,(E,T,X,plus,n,lparen,rparen,eps) = G1
    ...
    ################################################################
    def test_grammar_1(self,G2:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
    ...
    def test_grammar_2(self,G3:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
    ...
    def test_grammar_3(self,G4:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,(S,A,B,a,eps) = G4
    ...
    def test_grammar_4(self,G5:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,(S,A,a,b,c) = G5
    ...
    def test_grammar_5(self,G6:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,(A,B,a) = G6
    ...
    def test_grammar_6(self,G7:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,(S,a) = G7
    ...
    def test_grammar_regularity_1(self,G8:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        GL,_ = G8
    ...
    def test_grammar_regularity_2(self,G4:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,_ = G4
    ...
    def test_grammar_regularity_3(self,G6:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,_ = G6
    ...
    def test_grammar_regularity_4(self,G7:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,_ = G7
    ...
    def test_grammar_irregularity_1(self,G1:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,_ = G1
        
        assert not Grammar.IsRegular(G)
    
    def test_grammar_irregularity_2(self,G2:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,_ = G2

        assert not Grammar.IsRegular(G)
    
    def test_grammar_irregularity_3(self,G3:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,_ = G3

        assert not Grammar.IsRegular(G)
    
    def test_grammar_irregularity_4(self,G5:Tuple[AttributedGrammar,Tuple[Symbol,...]]):
        G,_ = G5

        assert not Grammar.IsRegular(G)
    
    def test_grammar_regularity_5(self,G9:AttributedGrammar):
    ...
    def test_grammar_attributed_add_production(self):
        ...
        G[E] += (E,plus,T),reductor

        assert G.get_reductor(Production(E,[E,plus,T])) == reductor
    ...
    def test_grammar_attributed_add_production_twice_different_reductor(self):
        ...
        G[E] += (E,plus,T),reductor_1
        G[E] += (E,plus,T),reductor_2

        assert G.get_reductor(Production(E,[E,plus,T])) == reductor_2
    ...
    def test_grammar_attributed_add_many_productions(self):
        ...
        G[E] += (E,plus,T),reductor_1
        G[E] += (E,minus,T),reductor_2

        assert G.get_reductor(Production(E,[E,plus,T])) == reductor_1
        assert G.get_reductor(Production(E,[E,minus,T])) == reductor_2