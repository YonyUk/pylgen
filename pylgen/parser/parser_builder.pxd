...
cdef tuple[set[LALRState],dict[tuple[LR0State,LR0Item],set[Symbol]],dict[tuple[LR0State,LR0Item,Symbol,LR0State,LR0Item],set[Symbol]]] _get_canonical_lalr_states(Grammar g,bint keep_edge_propagation_info=*)
