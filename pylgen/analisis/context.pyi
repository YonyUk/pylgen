...
class Context:
    ...
    def push_trace(self,trace:str) -> None: ...
    ...
    def clear_runtimes_errors(self) -> None: ...

    def clear_semantic_errors(self) -> None: ...
    
    def reset(self) -> None: ...

    def clear_errors(self) -> None: ...

    def add_semantic_error(self, error:SemanticError) -> None: ...
