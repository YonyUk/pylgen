...
> ### 5. Interactive Profiling Data (Scalene HTML Reports)
...
- **PyLGEN Full Report**: [`scalene_pylgen.html`](../images/benchmark/pylgen/scalene-pylgen.html)  
...
>
> 2. **Memory Timeline**: The memory allocation graphs provide a visual confirmation of the peak usage disparity—PyLGEN's graph stays under ~900 MB, while Lark's allocation curve reaches ~4 GB.
>
